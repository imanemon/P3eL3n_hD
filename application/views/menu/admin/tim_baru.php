		...
		<div class="row">
			<div class="grid simple">
				<div class="grid-title no-border">
					<h4><span class="semi-bold">Tambah Tim Baru</span></h4>
					</div>
				<div class="grid-body no-border">
					<div class="form-group">
						<label class="semi-bold">Nama Team</label>
						<div class="input-with-icon  right">                                       
							<i class=""></i>
							<input type="text" name="nama_tim" id="form1CardHolderName" class="form-control" required>                                 
						</div>
					</div>
				</div>
			</div>				
